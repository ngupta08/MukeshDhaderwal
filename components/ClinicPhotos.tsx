    ...
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="group relative rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-white/20 backdrop-blur-sm bg-gradient-to-br from-cyan-600/90 to-teal-600/90">
            <div className="relative p-4 md:p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-white mb-2 sm:mb-1 drop-shadow-md text-base sm:text-lg">Timings</h3>
                  <p className="text-xs sm:text-sm text-white/90 drop-shadow-sm">9AM - 12PM, 5PM - 8 PM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="group relative rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-white/20 backdrop-blur-sm bg-gradient-to-br from-emerald-600/90 to-teal-600/90">
            <div className="relative p-4 md:p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-white mb-2 sm:mb-1 drop-shadow-md text-base sm:text-lg">Contact</h3>
                  <p className="text-xs sm:text-sm text-white/90 drop-shadow-sm">095090 46236</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-8 sm:mt-12 md:mt-16 px-2">
          <p className="text-white/90 mb-4 sm:mb-6 text-base sm:text-lg drop-shadow-md">
